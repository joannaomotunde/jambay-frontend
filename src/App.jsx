  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/events-browse" element={<ProtectedRoute><EventsBrowse /></ProtectedRoute>} />
        <Route path="/concessions" element={<ProtectedRoute><Concessions /></ProtectedRoute>} />
        <Route path="/loyalty" element={<ProtectedRoute><Loyalty /></ProtectedRoute>} />

        {/* Operator/Admin Routes */}
        <Route path="/operator" element={<ProtectedRoute allowedRoles={['admin']}><OperatorDashboard /></ProtectedRoute>} />
        <Route path="/analytics" element={<ProtectedRoute><SalesAnalytics /></ProtectedRoute>} />
        <Route path="/fraud-alert" element={<ProtectedRoute><FraudAlert /></ProtectedRoute>} />
        ...
        <Route path="/ticket-detail" element={<ProtectedRoute><TicketDetail /></ProtectedRoute>} />
